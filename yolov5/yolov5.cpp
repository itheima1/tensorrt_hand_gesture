...
ICudaEngine* build_engine(unsigned int maxBatchSize, IBuilder* builder, IBuilderConfig* config, DataType dt, float& gd, float& gw, std::string& wts_name) {
    ...
    config->setMaxWorkspaceSize(16 * (1 << 20) * 16) ;  // 16MB
#if defined(USE_FP16)
    ...
    Int8EntropyCalibrator2* calibrator = new Int8EntropyCalibrator2(1, INPUT_W, INPUT_H, "/root/ws/datasets_1100/", "int8calib.table", INPUT_BLOB_NAME);
